...
package TidyAll::Plugin::LIGERO::Common::CustomizationMarkers;
## nofilter(TidyAll::Plugin::LIGERO::Common::CustomizationMarkers)
## nofilter(TidyAll::Plugin::LIGERO::Common::Origin)
...
sub validate_source {    ## no critic
    ...
    if ($ErrorMessage) {
        die __PACKAGE__ . "\n" . <<EOF;
Please remove or replace wrong Separators like '# --', valid only: # --- (for customizing ligero files).
$ErrorMessage
EOF
    }
