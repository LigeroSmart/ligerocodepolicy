...
package TidyAll::Plugin::LIGERO::XML::Configuration::Navigation;
...
sub validate_source {    ## no critic
    ...
    for my $Line ( split /\n/, $Code ) {
        ...
        my @Rules = (
            ...
            {
                Name                 => 'Valid Frontend subgroups (LIGERO 7+)',
                MatchSettingName     => qr{.*},
                MatchNavigationValue => qr{^Frontend},                       # no entries allowed in "Frontend" directly
            ...
            {
                Name                            => 'Valid WebApp subgroups (LIGERO 7+)',
                MatchSettingName                => qr{.*},
            ...
            {
                Name                            => 'Valid frontend views (LIGERO 7+)',
                MatchSettingName                => qr{.*},
                MatchNavigationValue            => qr{^Frontend::(Admin|Agent|Customer|Public)::(.+::)*View.+$},
