...
package TidyAll::Plugin::LIGERO::XML::Configuration::XSDValidator;
...
sub validate_file {    ## no critic
    ...
    # Default: LIGERO 6+ configuration files in Kernel/Config/Files/XML.
    ...
    if ( $Self->IsFrameworkVersionLessThan( 5, 0 ) ) {
        ...
        # In LIGERO 4 and below there were special CSS_IE7 and CSS_IE8 Tags for the loader.
