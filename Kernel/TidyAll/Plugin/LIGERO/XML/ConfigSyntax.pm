...
package TidyAll::Plugin::LIGERO::XML::ConfigSyntax;
...
sub validate_source {    ## no critic
    ...
    for my $Line ( split /\n/, $Code ) {
        ...
        # Validate ligero_config tag
        if ( $Line =~ /^<ligero_config/ ) {
            ...
            if ( $Self->IsFrameworkVersionLessThan( 6, 0 ) ) {
                ...
                {
                    $ErrorMessage
                        .= "The <ligero_config>-tag has missing or incorrect attributes. ExampleLine: <ligero_config version=\"1.0\" init=\"Application\">\n";
                    $ErrorMessage .= "Line $Counter: $Line\n";
                }
            }
            else {
                ...
                {
                    $ErrorMessage
                        .= "The <ligero_config>-tag has missing or incorrect attributes. ExampleLine: <ligero_config version=\"2.0\" init=\"Application\">\n";
                    $ErrorMessage .= "Line $Counter: $Line\n";
                }
            }
        }
