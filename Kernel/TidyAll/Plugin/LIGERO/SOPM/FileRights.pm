...
package TidyAll::Plugin::LIGERO::SOPM::FileRights;
...
sub validate_source {    ## no critic
    ...
    # A little more lenient before LIGERO 8 (with group executable permissions)
    ...
    # A lot more lenient before LIGERO 6 (world permissions)
