...
package TidyAll::Plugin::LIGERO::Legal::LicenseValidator;
...
sub transform_source {    ## no critic
    ...
    #     This software is part of the LIGERO project (L<http://ligero.com/>).
    #     This software is part of the LIGERO project (<http://ligero.com/>).
    #
    # Replacement:
    #     This software is part of the LIGERO project (https://ligero.org/).
    #
    $Code =~ s{
        ^ ( (?: \# \s+ | \/\/ \s+ |  ) ) This \s+ software \s+ is \s+ part \s+ of \s+ the \s+ LIGERO \s+ project \s+ \( (?: L< | < ) http (?: s |  ) :\/\/ligero\. (?: org | com ) \/>\) \.
    }{$1This software is part of the LIGERO project (https://ligero.org/).}xmsg;
    ...
    if ( $Code =~ m{ ^ \s* use \s+ warnings\; \s* $ }smx ) {
        ...
        #
        $Code =~ s{
            ^ This \s+ software \s+ is \s+ part \s+ of \s+ the \s+ LIGERO \s+ project \s+ \( (?: L< | < |  ) http (?: s |  ) :\/\/ligero\. (?: org | com ) \/ (?: > |  ) \) \.
        }{This software is part of the LIGERO project (L<https://ligero.org/>).}xmsg;
    ...
    # Original:
    #     /**
    #      * @project     LIGERO (http://www.ligero.org) - Agent Frontend
    #      * @copyright   LIGERO AG
    ...
    # Replacement:
    #     /*
    #     Copyright (C) 2018-2018 LIGERO AG, https://ligero.com/
    #
    #     This software comes with ABSOLUTELY NO WARRANTY. For details, see
    #     the enclosed file COPYING for license information (GPL). If you
    #     did not receive this file, see https://www.gnu.org/licenses/gpl-3.0.txt.
